...
class PlanSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $plans = [
            ["plan_name" => "Monthly", "plan_id" => "price_1OjJrqLyI7mncMRJxo1KhAy6", "actual_price" => "1","recurring_price" => "5",  "description"=>"Logo icon, Unlimited categories, Business tagline & full description, Link to website", "currency"=>"USD"],
